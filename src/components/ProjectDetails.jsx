...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-auto backdrop-blur-sm">
      <motion.div
        className="relative max-w-2xl border max-h-[calc(100vh-4rem)]  overflow-auto scrollbar-hide shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10"
